/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 94ae50651115d5d5717871bada34d521)
// Runtime types generated with workerd@1.20260128.0 2025-01-29 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/server");
    durableNamespaces: "Sandbox" | "TaskRunner";
  }
  interface Env {
    ...
    COMPUTESDK_API_KEY: string;
    Sandbox: DurableObjectNamespace<import("./src/server").Sandbox>;
    TaskRunner: DurableObjectNamespace<import("./src/server").TaskRunner>;
  }
}
